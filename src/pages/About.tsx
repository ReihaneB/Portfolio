          ...
          <div className="lg:w-1/2 lg:flex lg:items-center">
            <div className="">
                ...
                {social.map((item: any) =>
                  Object.values(item).map((item: any, index: number) => (
                    <a
                      ...
                      className="text-blue-500 bg-blue-100 rounded-full px-4 mt-4 py-2 mr-2 flex flex-nowrap"
                    >
                      <img src={item.img} alt={item.alt} className="w-4 mr-2" />
                      {item.intitule}
                    </a>
                  ))
                )}
              ...
              <div className="mt-6">
                ...
                <p className="mt-4">
                  En prenant le temps de bien comprendre les besoins de chacun,
                  je peux créer un projet sur-mesure qui leur apportera une
                  vraie plus-value. C'est ce qui me motive au quotidien et me
                  permet de donner le meilleur de moi-même pour chaque projet.
                </p>
              </div>
            </div>
          </div>
