            ...
            <>
              ...
              <div className="flex justify-center">
                <p className="mt-4 text-left lg:text-center lg:w-[650px]">
                  Vous retrouverez ici mes side-projects, expériences et outils
                  que j'ai développé sur mon temps libre et qui ne sont pas
                  encore assez matures pour être intégrées dans mes projets.
                </p>
              </div>
            </>
          ) : (
