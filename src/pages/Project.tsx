        ...
        {projects.map((project: any, index: number) => (
          <div key={index}>
            <div className="mt-32">
              ...
              <div className="flex place-content-between">
                ...
                <div className="hidden lg:flex lg:justify-end lg:items-end">
                    <a href={project.externalLink} target="_blank" rel="noopener noreferrer" className="px-8  bg-gradient-to-r from-purple-500 to-pink-500 rounded-full  py-3 text-white">
            ...
            <div className="mt-6 flex justify-center lg:hidden">
              <a href={project.externalLink} target="_blank" rel="noopener noreferrer" className="px-8 py-3 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full  text-white">
                {project.buttonTextExternalLink}
              </a>
            </div>
            ...
            <div className="lg:flex">
              <div className="lg:mr-16">
                {project.additionalinformations.graphicalcharter &&
                  project.additionalinformations.graphicalcharter
                    .typography && <h3 className="mt-8">Typographie</h3>}
                {project.additionalinformations.graphicalcharter &&
            ...
            {nextproject?nextproject.filter((work: any) => work.id === nextWorkProjectID)
