  ...
  return [
    {
      ...
      theGoalDescription:
        "La marque de bijoux fait preuve d'un fort potentiel de croissance, notamment grâce à son identité visuelle forte et à ses nouvelles technologies inédites. Le site e-commerce doit donc coller au visuel de la marque et offrir aux utilisateurs une nouvelle manière de découvrir les bijoux. Pour ce faire, le site doit proposer une expérience utilisateur fluide et intuitive, ainsi qu'un design épuré et moderne. De plus, il doit offrir une gamme de fonctionnalités innovantes permettant aux utilisateurs de découvrir les bijoux de manière interactive. Enfin, le site e-commerce doit être optimisé pour les moteurs de recherche afin d'attirer un maximum de visiteurs.",
      ...
      images: {
        ...
        Produit: {
          ...
          4: {
            alt: "Page produit de Liome avec récapitulatif",
            img: liomeproduct4,
          },
        },
        "Mon compte": {
      ...
      additionalinformations: {
        delivreables: [
          "Web-app responsive",
          "Gestion des paiements avec l'intégration de l'API Stripe",
          "Gestion des livraisons avec l'intégration de l'API UPS",
          "Gestion du contenu avec CMS propriétaire",
          "Optimisation SEO",
...

    {
      ...
      theGoalDescription:
        "Les visuels 3D permettent de mieux mettre en valeur les bijoux. Cela permet des les présenter sous différents angles et avec différents éclairages pour montrer leur beauté sous tous les angles. Les visuels 3D peuvent également être utilisés pour mettre en valeur les détails des bijoux, ce qui peut être utile pour les clients qui souhaitent en savoir plus sur les bijoux qu'ils envisagent d'acheter.",
      stackSummary: ["Blender", "Photoshop", "Lightroom", "Substance painter"],
      stack: {
        "Création 3D": {
          "Modélisation des bijoux": {
      ...
      images: {
        ...
        "Anneau 92U": {
          1: { alt: "Anneau 92U dans un réacteur nucléaire", img: u92 },
        ...
        "Bague Dune": {
          ...
          2: { alt: "Bague Dune portée sur l'annulaire", img: dune2 },
        },
        "Anneau Ancestral": {
        ...
        "Chevalière Sealed": {
          1: { alt: "Chevalière Sealed dans une mine", img: sealed },
          2: { alt: "Chevalière Sealed sur fond noir", img: sealed2 },
        },
        "Bague Star": {
        ...
        "Bague Tear": {
          1: { alt: "Bague Tear posée sur une table", img: tear },
        },
      },
      additionalinformations: {
        delivreables: [
...

    {
      ...
      secondImageAlt:
        "Accueil de Ultra-book avec call-to-action pour créer un portfolio",
      buttonTextExternalLink: "Visiter le site",
      externalLink: "https://ultra-book.com",
      projectDescription:
        "Ultra-book est une plateforme de mise à disposition de thème qui permet aux créatifs de tous les niveaux de créer un portfolio en ligne en quelques minutes. Plus de 60 000 créateurs ont déjà un portfolio hébergé en ligne qui leurs permet de partager facilement leurs créations à leurs clients et prospects. Le site propose également des outils pour gérer les contacts et les demandes de devis afin de permettre aux créatifs de gagner du temps et de se concentrer sur ce qu'ils font de mieux : créer !",
      theGoal: "Améliorer l'expérience utilisateur avec un nouveau design",
      theGoalDescription:
        "Le site web de l'entreprise a été refait afin d'améliorer l'expérience utilisateur et l'accessibilité. Le nouveau design est plus moderne et épuré, avec des couleurs plus douces et des formes plus arrondies. L'objectif étant de rendre la navigation plus intuitive et agréable. Les utilisateurs pourront trouver plus facilement toutes les informations dont ils ont besoin grâce à une navigation plus fluide et agréable.",
      ...
      images: {
        Accueil: {
          ...
          2: {
            alt: "Accueil de Ultra-book avec call-to-action pour créer un portfolio",
            img: ultrabookhomepage2,
          },
          3: {
            alt: "Accueil de Ultra-book avec les réseaux sociaux",
            img: ultrabookhomepage3,
          },
        },
        "Modèles de thème de portfolio": {
          1: {
            alt: "Portfolio d'un thème custom de Ultra-book",
            img: ultrabookporfolio,
          },
          2: {
            alt: "Portfolio du thème ultra-frais de Ultra-book",
