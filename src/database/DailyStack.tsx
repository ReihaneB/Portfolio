...
export default function DailyStack(): any {
  return [
    {
      "Front-end": {
        1: { intitule: "React", img: react, alt: "React logo" },
        2: { intitule: "TailwindCSS", img: tailwindcss, alt: "TailwindCSS logo" },
        ...
        8: { intitule: "Framer Motion", img: framermotion, alt: "Framer Motion logo" },
      ...
      "IDE": {
        1: { intitule: "Visual Studio Code", img: vscode, alt: "Visual Studio Code logo" },
      },
      "Design 2D": {
        ...
        4: { intitule: "Illustrator", img: illustrator, alt: "Illustrator logo" },
      ...
      "Design 3D": {
        ...
        2: {intitule: "Substance Painter", img: substancepainter, alt: "Substance Painter logo" },
        3: { intitule: "Panther 3D", img: panther3d, alt: "Panther 3D logo" },
        4: { intitule: "Nomad sculpt", img: nomadsculpt, alt: "Nomad sculpt logo" },
        5: { intitule: "ZBrush", img: zbrush, alt: "ZBrush logo" },
        6: { intitule: "Keyshot", img: keyshot, alt: "Keyshot logo" },
      },
      "Motion design": {
        1: { intitule: "After Effects", img: aftereffects, alt: "After Effects logo" },
        2: { intitule: "Premiere Pro", img: premierepro, alt: "Premiere Pro logo" },
      },
      "Méthodes de travail": {
        1: { intitule: "SCRUM", img: scrum, alt: "SCRUM logo" },
        2: { intitule: "Agile", img: scrum, alt: "SCRUM logo" },
        3: { intitule: "Pair programming", img: pairprogramming, alt: "Pair programming logo" },
        4: { intitule: "Atomic design", img: atomicdesign, alt: "Atomic design logo" },
      ...
      "En cours d'apprentissage": {
        ...
        3: { intitule: "Réalité augmentée", img: augmentedreality, alt: "Réalité augmentée logo" },
